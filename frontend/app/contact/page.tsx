...
const categories = ['General Inquiry', 'Membership', 'Finance', 'IES Programs', 'Other Inquiry'];
      ...
      <section className="bg-gradient-to-b from-[#035CB3] to-[#024A8F] py-14 text-center text-white">
        <SiteContainer>
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm text-blue-100">
            Have a question or want to learn more about IES? We&apos;d love to hear from you.
          </p>
        </SiteContainer>
      </section>
        ...
        <div className="grid gap-0 overflow-hidden rounded-2xl border border-slate-200 shadow-sm lg:grid-cols-[1fr_1.2fr]">
            ...
            <div className="mt-8 flex flex-col gap-6">
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-red-400">{site.contact.closedDay}: Closed</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white p-8 lg:p-10">
            {status === 'sent' ? (
              ...
              <>
                <h3 className="text-xl font-bold text-[#022D5A]">Send Us a Message</h3>
                <p className="mt-1 text-sm text-slate-500">Fill out the form below and we&apos;ll respond as soon as possible.</p>
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                  ...
                  {status === 'error' && (
                    <p className="text-sm text-red-600">Something went wrong. Please try again or email us directly at {site.contact.generalEmail}.</p>
                  )}
