...
export const ComplaintFormClient = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const payload = {
      ...
      isMember,
      regNumber: isMember ? formData.get('regNumber') : undefined,
    };
  ...
  return (
    <>
      <section className="bg-gradient-to-b from-[#035CB3] to-[#024A8F] py-14 text-center text-white">
        <SiteContainer>
          <h1 className="text-3xl font-extrabold tracking-tight sm:text-4xl">Complaint Submission</h1>
          <p className="mx-auto mt-3 max-w-xl text-sm text-blue-100">
            Submit a formal complaint or report a violation to the Institution of Engineers Somalia.
          </p>
        </SiteContainer>
      </section>
        ...
        <div className="grid gap-0 overflow-hidden rounded-2xl border border-slate-200 shadow-sm lg:grid-cols-[1fr_1.2fr]">
          ...
          <div className="border-b border-slate-100 bg-slate-50 p-8 lg:border-b-0 lg:border-r lg:p-10">
            ...
            <div className="mt-8 flex flex-col gap-6">
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-slate-500">4th Floor, Adani Tower, Maka Al-mukarama Street, Hodan District, Mogadishu</p>
                </div>
              </div>
            ...
            <div className="mt-8 border-t border-slate-200 pt-8">
              {[
                { title: 'Membership & Registration', email: 'membership@iesomalia.org.so', phone: '+252 612267137' },
                { title: 'Finance & Payments', email: 'finance@iesomalia.org.so', phone: '+252 614240602' },
                { title: 'General Inquiries', email: 'info@iesomalia.org.so', phone: '+252 612267178' },
              ].map((dept) => (
                <div key={dept.title} className="mb-6 last:mb-0">
                  ...
                  <div className="mt-2 flex flex-col gap-1.5">
                    <div className="flex items-center gap-2.5">
                      ...
                      <a href={`mailto:${dept.email}`} className="text-sm text-slate-500 transition-colors hover:text-[#035CB3]">{dept.email}</a>
                    </div>
                    <div className="flex items-center gap-2.5">
                      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#035CB3]/8">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#035CB3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      <a href={`tel:${dept.phone.replace(/\s/g, '')}`} className="text-sm text-slate-500 transition-colors hover:text-[#035CB3]">{dept.phone}</a>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="bg-white p-8 lg:p-10">
            {submitted ? (
              <div className="flex flex-col items-center gap-3 py-10 text-center">
                ...
                <h3 className="text-lg font-bold text-slate-800">Complaint Submitted Successfully!</h3>
                <p className="max-w-xs text-sm text-slate-500">
                  Your complaint has been received and will be reviewed by the appropriate committee.
                </p>
                <button
                  type="button"
              ...
              <>
                <h3 className="text-xl font-bold text-[#022D5A]">Report Violations by Filling the Form</h3>
                <p className="mt-1 text-sm text-slate-500">All submissions are reviewed by the relevant committee.</p>
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="relative">
                      ...
                      >
                        <option value="" disabled>Violation Type</option>
                  ...
                  <textarea
                    ...
                    rows={5}
                    required
                    placeholder="Describe the violation or concern in detail..."
