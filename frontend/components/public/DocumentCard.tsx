...
export const DocumentCard = ({ doc }: { doc: DocumentItem }) => (
  <Card className="flex items-start gap-3" padded interactive>
    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-blue-50 text-[#0047AB]">
    ...
    <div className="flex flex-col gap-1">
      <a href={doc.href} className="text-sm font-semibold text-[#082B55] hover:text-[#0047AB]">
        {doc.title}
      </a>
